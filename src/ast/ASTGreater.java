...
public class ASTGreater implements ASTNode {
    ...
    public ASTGreater(ASTNode leftExpression, ASTNode rightExpression) {
    ...
    public IType typecheck(IEnvironment<IType> environment)
        ...
        throw new TypingException("Wrong types in greater operation!");
    }
    ...
    public void assemble(IAssembler assembler) {
        ...
        assembler.if_icmple(falseLabel);
