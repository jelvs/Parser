...
public class ASTSubtraction implements ASTNode {

    private ASTNode leftExpression;
    private ASTNode rightExpression;
    private IType expressionType;

    public ASTSubtraction(ASTNode leftExpression, ASTNode rightExpression) {
    ...
    public IType typecheck(IEnvironment<IType> environment)
        ...
        throw new TypingException("Wrong types in subtraction operation!");
    }
