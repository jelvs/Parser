...
public class ASTLesser implements ASTNode {
    ...
    public ASTLesser(ASTNode leftExpression, ASTNode rightExpression) {
    ...
    public IType typecheck(IEnvironment<IType> environment)
        ...
        throw new TypingException("Wrong types in lesser operation!");
    }
    ...
    public void assemble(IAssembler assembler) {
        ...
        assembler.if_icmpge(falseLabel);
